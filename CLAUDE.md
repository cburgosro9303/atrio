...
**Completadas: T-001, T-002, T-010, T-011, T-012, T-020, T-021, T-030 y T-040, más T-042 en su mitad de almacén.** Módulo `github.com/cburgosro9303/atrio`, Go 1.26, los 8 paquetes con sus `doc.go`, test de arquitectura, pipeline de CI, los 12 esquemas —los 9 de artefactos, el manifiesto del marketplace y las dos definiciones canónicas del catálogo—, el repositorio de artefactos JSON, la base local SQLite y las notificaciones internas en `store/`, la envoltura segura de git en `gitops/` y el dominio puro en `core/`. **ADR-017** añadido (front-matter YAML validado, acota ADR-005).
